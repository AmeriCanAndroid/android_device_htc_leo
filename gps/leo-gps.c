...
const OldGpsInterface* gps_get_hardware_interface()
{
    return &sLocEngInterface;
}

EXTERN_SYMBOL(get_gps_hardware_interface);

// for gps.c
const OldGpsInterface* get_gps_interface()
{
	return &sLocEngInterface;
}
